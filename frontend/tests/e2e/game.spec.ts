...
test.describe('TicTacToe game', () => {
  test('two players can play a full game', async ({ players }) => {
  ...
  test('turn timeout ends the game', async ({ players }) => {
    const { p1, p2, p1Id } = players
    await setupAndStartGame(p1, p2, p1Id)
  ...
  test('player can forfeit a game', async ({ players }) => {
    const { p1, p2, p1Id } = players
    await setupAndStartGame(p1, p2, p1Id)
  ...
  test('both players can rematch after a game ends', async ({ players }) => {
    const { p1, p2, p1Id } = players
    await setupAndStartGame(p1, p2, p1Id)
    await playFullGame(p1, p2)
  ...
  test('rematch full flow: vote, return to lobby, start second game', async ({ players }) => {
    const { p1, p2, p1Id } = players
  ...
  test('back to lobby button after game ends closes socket and redirects', async ({ players }) => {
    const { p1, p2, p1Id } = players
    await setupAndStartGame(p1, p2, p1Id)
    await playFullGame(p1, p2)
  ...
  test('occupied cell is disabled and cannot be clicked', async ({ players }) => {
    const { p1, p2, p1Id } = players
    await setupAndStartGame(p1, p2, p1Id)
