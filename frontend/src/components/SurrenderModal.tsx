...
export default function SurrenderModal({ onConfirm, onCancel, isPending }: Props) {
  return (
    <div className={styles.overlay}>
      <div className={styles.dialog} role="dialog" aria-modal="true" aria-labelledby="surrender-title">
        <h2 id="surrender-title" className={styles.title}>Forfeit game?</h2>
        <p className={styles.body}>
          You will be recorded as the loser. Your opponent wins.
        </p>
