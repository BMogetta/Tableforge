...
import (
	...
	"github.com/recess/services/ws-gateway/internal/consumer"
	"github.com/recess/services/ws-gateway/internal/handler"
...
func main() {
	...
	r.With(authMW).Get("/ws/players/{playerID}", handler.PlayerHandler(h, ps, userClient, gameClient))
